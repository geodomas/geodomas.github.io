...
The live GitHub Public Lab runs deterministic tools **client-side**. It does not depend on a public private-data API.
...
- CALC Mesh Analyzer — analyzes a user-selected CALC JSON file locally in the browser; the file is not uploaded by the Public Lab tool.
